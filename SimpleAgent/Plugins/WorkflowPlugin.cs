...
namespace SimpleAgent.Plugins
{
    public class WorkflowPlugin
    {
        ...
        public WorkflowPlugin(AgentContext context)
        {
        ...
        {
            context.NextState = WorkflowState.Planning;
        ...
        {
            context.NextState = WorkflowState.Developing;
            return "[系统通知] 路由成功！请立即停止调用任何工具，并直接结束对话。";
        }
        ...
        {
            context.DeveloperSummary = summary;
            context.NextState = WorkflowState.Reviewing;
        ...
        {
            context.NextState = WorkflowState.Completed;
        ...
        {
            context.ReviewerFeedback = feedback;
            context.NextState = WorkflowState.Developing;
