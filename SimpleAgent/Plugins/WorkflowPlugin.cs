...
namespace SimpleAgent.Plugins
{
    public class WorkflowPlugin
    {
        ...
        {
            _context.NextState = WorkflowState.Planning;
        ...
        {
            _context.NextState = WorkflowState.Developing;
            return "[系统通知] 路由成功！请立即停止调用任何工具，并直接结束对话。";
        }
        ...
        public string SubmitForReview([Description("本次修改的内容、文件以及测试结果总结")] string summary)
        {
            ...
            _context.NextState = WorkflowState.Reviewing;
        ...
        {
            _context.NextState = WorkflowState.Completed;
