...
namespace SimpleAgent
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            OpenProjectButton = new FlatButton();
            ConversationTreeView = new FlatTreeView();
            label5 = new Label();
            label3 = new Label();
            label4 = new Label();
            CreateConversationButton = new FlatButton();
            ...
            TopMenu_File_OpenProject.Size = new Size(124, 22);
            ...
            模型配置ToolStripMenuItem.Click += OpenSettings;
            // 
            // TopMenu_Help
            // 
            ...
            LeftPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            LeftPanel.Controls.Add(OpenProjectButton, 1, 0);
            ...
            LeftPanel.Controls.Add(CreateConversationButton, 1, 2);
            ...
            // OpenProjectButton
            // 
            OpenProjectButton.BackColor = Color.DodgerBlue;
            OpenProjectButton.Dock = DockStyle.Fill;
            OpenProjectButton.FlatAppearance.BorderSize = 0;
            OpenProjectButton.FlatAppearance.MouseDownBackColor = SystemColors.Highlight;
            OpenProjectButton.FlatAppearance.MouseOverBackColor = Color.DeepSkyBlue;
            OpenProjectButton.FlatStyle = FlatStyle.Flat;
            OpenProjectButton.ForeColor = Color.White;
            OpenProjectButton.Location = new Point(175, 3);
            OpenProjectButton.Margin = new Padding(50, 3, 0, 3);
            OpenProjectButton.Name = "OpenProjectButton";
            OpenProjectButton.Size = new Size(75, 24);
            ...
            LeftPanel.SetColumnSpan(ConversationTreeView, 2);
            ...
            ConversationTreeView.LabelEdit = true;
            ...
            LeftPanel.SetColumnSpan(label4, 2);
            ...
            // 
            CreateConversationButton.BackColor = Color.DodgerBlue;
            CreateConversationButton.Dock = DockStyle.Fill;
            CreateConversationButton.Enabled = false;
            CreateConversationButton.FlatAppearance.BorderSize = 0;
            CreateConversationButton.FlatAppearance.MouseDownBackColor = SystemColors.Highlight;
            CreateConversationButton.FlatAppearance.MouseOverBackColor = Color.DeepSkyBlue;
            CreateConversationButton.FlatStyle = FlatStyle.Flat;
            CreateConversationButton.ForeColor = Color.White;
            CreateConversationButton.Location = new Point(175, 210);
            CreateConversationButton.Margin = new Padding(50, 3, 0, 3);
            CreateConversationButton.Name = "CreateConversationButton";
            CreateConversationButton.Size = new Size(75, 24);
            CreateConversationButton.TabIndex = 9;
            CreateConversationButton.Text = "新建会话";
            CreateConversationButton.UseVisualStyleBackColor = false;
            CreateConversationButton.Click += CreateConversationButton_Click;
            // 
            // MiddlePanel
            // 
            ...
            SendButton.FlatAppearance.MouseDownBackColor = SystemColors.Highlight;
		...
		private FlatButton CreateConversationButton;
		private FlatButton OpenProjectButton;
	}
}
